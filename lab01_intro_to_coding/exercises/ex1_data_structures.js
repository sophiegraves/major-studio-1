...
var museums2 = {};
names.forEach((n, i) => {
  //passing two paramaters (n and i) for this to work - n is the iterator, i is counting
  //grabs first entry names; first paramater is n, i is a counter. Will see in d3 a lot. "data, iterate"
  //"forEach" - going beginning to end no matter what is in array
...
addAMuseum(museums2, "MoMath", "momath.com", 1974);
